...
The reference documentation is available at: [keycloak-clojure.org](https://keycloak-clojure.org).
...
Read the [sample's README](sample) to understand the concepts Keycloak offers, and the integration points needed to integrate it with your application backend and frontend. Of course the way Keycloak integrates with your application depends on the stack it uses.
